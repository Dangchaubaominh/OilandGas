...
export default function UserManagement() {
  ...
  const onSubmitForm = async (data) => {
    ...
    try {
      ...
      const errorMsg =
        err.response?.data?.message || err.message || "Lỗi thao tác.";
      showToast(
        "error",
        `${isEditMode ? "Cập nhật" : "Tạo mới"} thất bại: ${errorMsg}`,
      );
    } finally {
      setIsSaving(false);
    }
  ...
  const handleDelete = async (userId, userName) => {
    ...
    try {
      ...
      const errorMsg =
        err.response?.data?.message || err.message || "Lỗi xóa user.";
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <div className="modal-body">
                ...
                <div className="form-group">
                  <label>
                    Password {isEditMode ? "(Bỏ trống nếu giữ nguyên)" : "*"}
                  </label>
              ...
              <div className="modal-footer">
                ...
                >
                  {isEditMode ? (
                    <>
                      <FaSave />{" "}
                      {isSaving ? "Đang cập nhật..." : "Cập nhật User"}
                    </>
                  ) : (
                    <>
                      <FaUserPlus /> {isSaving ? "Đang tạo..." : "Tạo User"}
                    </>
                  )}
                </button>
              </div>
