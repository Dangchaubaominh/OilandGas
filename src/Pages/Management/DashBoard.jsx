      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--bg-card)] rounded-2xl p-6 border border-[var(--border-primary)] shadow-md">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm flex items-center gap-1.5 text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">
              <FaFilter /> Filter
            </button>
          </div>
          <div className="space-y-4">
            {incidents.map((incident) => (
              <div
                key={incident.id}
                className="flex gap-4 p-4 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-primary)] border-l-2 border-l-red-500"
              >
