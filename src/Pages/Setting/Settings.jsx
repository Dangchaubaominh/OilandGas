    ...
    <div className="settings-page">
      <div className="settings-header">
        ...
        <p className="settings-subtitle">
          Configure security policies, operational parameters, and maintenance
          settings
        </p>
      </div>
              ...
              <div className="form-group">
                <label className="form-label-help">
                  ...
                  <span className="label-help">
                    Determines how often the development portal will
                    generate/notify related for maintenance events
                  </span>
                </label>
                <input
                  type="text"
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      schedulingFrequency: e.target.value,
                    })
                  }
                />
              </div>
